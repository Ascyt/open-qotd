...
namespace CustomQotd.Features.Commands
{
    ...
    public class ConfigCommand
    {
        ...
        public static async Task InitializeAsync(CommandContext context,
            ...
            [Description("Whether to send a _random preset when there is no Accepted QOTD available (true by default).")] bool EnableQotdAutomaticPresets = true,
        ...
        public static async Task SetAsync(CommandContext context,
            ...
            [Description("Whether to send a _random preset when there is no Accepted QOTD available (true by default).")] bool? EnableQotdAutomaticPresets = null,
