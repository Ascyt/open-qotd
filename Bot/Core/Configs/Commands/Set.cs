    ...
    public sealed partial class ConfigCommand
    {
        ...
        public sealed class ConfigSetCommand
        {
            ...
            public static async Task SetQotdMessageAsync(CommandContext context,
                ...
                [Description("The option for pinning QOTD messages. (defaults to \"PinMessageAndUnpinPrevious\") if unset).")] Config.PinMessageOption? QotdPinMessageOption = null,
            ...
            => await Helpers.General.SetAllAsync(context,
                ...
                QotdPinMessageOption: QotdPinMessageOption,
