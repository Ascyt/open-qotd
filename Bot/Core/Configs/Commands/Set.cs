    ...
    public sealed partial class ConfigCommand
    {
        ...
        public sealed class ConfigSetCommand
        {
            ...
            public static async Task SetQotdMessageAsync(CommandContext context,
                ...
                [Description("The option for pinning QOTD messages. (defaults to \"PinMessageAndUnpinPrevious\") if unset).")] Config.PinMessageOption? PinMessageOption = null,
            ...
            => await Helpers.General.SetAllAsync(context,
                ...
                QotdPinMessageOption: PinMessageOption,
            ...
            public static async Task SetSuggestionsAsync(CommandContext context,
                ...
                [Description("The role that can accept/deny suggestions (applies to those who can view the channel if unset).")] DiscordRole? ModRole = null,
